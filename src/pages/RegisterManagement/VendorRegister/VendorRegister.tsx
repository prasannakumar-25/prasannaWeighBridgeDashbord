...
// import acutuz from 'assets/logo/actuz.png'
// import Image from 'components/base/Image';

// const VendorRegister = (): ReactElement => {
    ...
    <div className="vm-root">
     {/* <Sidebar />s */}
      ...
      <main className="vm-content">
        ...
        {/* <Box className="vm-intro">
          <Typography variant="body1" color="textSecondary">
            Three example vendors are listed below. Use the Add Vendor button to register a new vendor. Click Edit to modify any vendor.
          </Typography>
        </Box> */}
